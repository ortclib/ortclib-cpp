    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpH264CodecCapabilityParameters : public wrapper::org::ortc::RTCRtpH264CodecCapabilityParameters
        {
          ...
          virtual void wrapper_init_org_ortc_RTCRtpH264CodecCapabilityParameters() noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpH264CodecCapabilityParameters(wrapper::org::ortc::RTCRtpH264CodecCapabilityParametersPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpH264CodecCapabilityParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
