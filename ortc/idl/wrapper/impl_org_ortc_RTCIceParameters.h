    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCIceParameters : public wrapper::org::ortc::RTCIceParameters
        {
          ...
          virtual void wrapper_init_org_ortc_RTCIceParameters() noexcept override;
          virtual void wrapper_init_org_ortc_RTCIceParameters(wrapper::org::ortc::RTCIceParametersPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCIceParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
