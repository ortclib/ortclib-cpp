    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCDtlsParameters : public wrapper::org::ortc::RTCDtlsParameters
        {
          ...
          virtual void wrapper_init_org_ortc_RTCDtlsParameters() noexcept override;
          virtual void wrapper_init_org_ortc_RTCDtlsParameters(wrapper::org::ortc::RTCDtlsParametersPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCDtlsParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
