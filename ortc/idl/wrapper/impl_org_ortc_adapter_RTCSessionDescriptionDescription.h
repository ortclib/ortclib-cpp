      ...
      namespace ortc {
        namespace adapter {
          ...
          struct RTCSessionDescriptionDescription : public wrapper::org::ortc::adapter::RTCSessionDescriptionDescription
          {
            ...
            void wrapper_init_org_ortc_adapter_RTCSessionDescriptionDescription() noexcept override;
            void wrapper_init_org_ortc_adapter_RTCSessionDescriptionDescription(wrapper::org::ortc::adapter::RTCSessionDescriptionDescriptionPtr source) noexcept override;
            void wrapper_init_org_ortc_adapter_RTCSessionDescriptionDescription(wrapper::org::ortc::JsonPtr json) noexcept override;
