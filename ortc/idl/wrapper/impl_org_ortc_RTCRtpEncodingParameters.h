    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpEncodingParameters : public wrapper::org::ortc::RTCRtpEncodingParameters
        {
          ...
          void wrapper_init_org_ortc_RTCRtpEncodingParameters() noexcept override;
          void wrapper_init_org_ortc_RTCRtpEncodingParameters(wrapper::org::ortc::RTCRtpEncodingParametersPtr source) noexcept override;
          void wrapper_init_org_ortc_RTCRtpEncodingParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
