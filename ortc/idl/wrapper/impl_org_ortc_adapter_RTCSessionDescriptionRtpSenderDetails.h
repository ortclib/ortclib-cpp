      ...
      namespace ortc {
        namespace adapter {
          ...
          struct RTCSessionDescriptionRtpSenderDetails : public wrapper::org::ortc::adapter::RTCSessionDescriptionRtpSenderDetails
          {
            ...
            virtual void wrapper_init_org_ortc_adapter_RTCSessionDescriptionRtpSenderDetails() noexcept override;
            virtual void wrapper_init_org_ortc_adapter_RTCSessionDescriptionRtpSenderDetails(wrapper::org::ortc::adapter::RTCSessionDescriptionRtpSenderDetailsPtr source) noexcept override;
            virtual void wrapper_init_org_ortc_adapter_RTCSessionDescriptionRtpSenderDetails(wrapper::org::ortc::JsonPtr json) noexcept override;
