    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCSrtpSdesCryptoParameters : public wrapper::org::ortc::RTCSrtpSdesCryptoParameters
        {
          ...
          virtual void wrapper_init_org_ortc_RTCSrtpSdesCryptoParameters() noexcept override;
          virtual void wrapper_init_org_ortc_RTCSrtpSdesCryptoParameters(wrapper::org::ortc::RTCSrtpSdesCryptoParametersPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCSrtpSdesCryptoParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
