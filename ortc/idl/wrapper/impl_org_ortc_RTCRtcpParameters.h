    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtcpParameters : public wrapper::org::ortc::RTCRtcpParameters
        {
          ...
          void wrapper_init_org_ortc_RTCRtcpParameters() noexcept override;
          void wrapper_init_org_ortc_RTCRtcpParameters(wrapper::org::ortc::RTCRtcpParametersPtr source) noexcept override;
          void wrapper_init_org_ortc_RTCRtcpParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
