    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpVp8CodecParameterSettings : public wrapper::org::ortc::RTCRtpVp8CodecParameterSettings
        {
          ...
          void wrapper_init_org_ortc_RTCRtpVp8CodecParameterSettings() noexcept override;
          void wrapper_init_org_ortc_RTCRtpVp8CodecParameterSettings(wrapper::org::ortc::RTCRtpVp8CodecParameterSettingsPtr source) noexcept override;
          void wrapper_init_org_ortc_RTCRtpVp8CodecParameterSettings(wrapper::org::ortc::JsonPtr json) noexcept override;
