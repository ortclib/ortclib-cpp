    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpHeaderExtension : public wrapper::org::ortc::RTCRtpHeaderExtension
        {
          ...
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtension() noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtension(wrapper::org::ortc::RTCRtpHeaderExtensionPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtension(wrapper::org::ortc::JsonPtr json) noexcept override;
