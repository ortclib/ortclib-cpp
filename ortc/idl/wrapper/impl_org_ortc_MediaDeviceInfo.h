    ...
    namespace org {
      namespace ortc {
        ...
        struct MediaDeviceInfo : public wrapper::org::ortc::MediaDeviceInfo
        {
          ...
          virtual void wrapper_init_org_ortc_MediaDeviceInfo() noexcept override;
          virtual void wrapper_init_org_ortc_MediaDeviceInfo(wrapper::org::ortc::MediaDeviceInfoPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_MediaDeviceInfo(wrapper::org::ortc::JsonPtr json) noexcept override;
