    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpRtxParameters : public wrapper::org::ortc::RTCRtpRtxParameters
        {
          ...
          void wrapper_init_org_ortc_RTCRtpRtxParameters() noexcept override;
          void wrapper_init_org_ortc_RTCRtpRtxParameters(wrapper::org::ortc::RTCRtpRtxParametersPtr source) noexcept override;
          void wrapper_init_org_ortc_RTCRtpRtxParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
