    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpHeaderExtensionParameters : public wrapper::org::ortc::RTCRtpHeaderExtensionParameters
        {
          ...
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtensionParameters() noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtensionParameters(wrapper::org::ortc::RTCRtpHeaderExtensionParametersPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCRtpHeaderExtensionParameters(wrapper::org::ortc::JsonPtr json) noexcept override;
