    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCIceGatherOptions : public wrapper::org::ortc::RTCIceGatherOptions
        {
          ...
          virtual void wrapper_init_org_ortc_RTCIceGatherOptions() noexcept override;
          virtual void wrapper_init_org_ortc_RTCIceGatherOptions(wrapper::org::ortc::RTCIceGatherOptionsPtr source) noexcept override;
          virtual void wrapper_init_org_ortc_RTCIceGatherOptions(wrapper::org::ortc::JsonPtr json) noexcept override;
