    ...
    namespace org {
      namespace ortc {
        ...
        struct RTCRtpOpusCodecCapabilityOptions : public wrapper::org::ortc::RTCRtpOpusCodecCapabilityOptions
        {
          ...
          void wrapper_init_org_ortc_RTCRtpOpusCodecCapabilityOptions() noexcept override;
          void wrapper_init_org_ortc_RTCRtpOpusCodecCapabilityOptions(wrapper::org::ortc::RTCRtpOpusCodecCapabilityOptionsPtr source) noexcept override;
          void wrapper_init_org_ortc_RTCRtpOpusCodecCapabilityOptions(wrapper::org::ortc::JsonPtr json) noexcept override;
