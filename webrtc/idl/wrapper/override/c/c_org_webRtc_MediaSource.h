...
WEBRTC_WRAPPER_C_EXPORT_API org_webRtc_MediaSource_t WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_MediaSource_wrapperCreate_MediaSourceWithNativeQueue(zs_Any_t queue);
