  ...
  namespace impl {
    namespace org {
      namespace webRtc {
        ...
        {
          ZS_DECLARE_TYPEDEF_PTR(wrapper::org::webRtc::RTCAudioSenderStats, WrapperType);
          ZS_DECLARE_TYPEDEF_PTR(wrapper::impl::org::webRtc::RTCAudioSenderStats, WrapperImplType);
